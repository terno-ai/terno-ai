...
from prompts import GENRIC_SQL
...
class PromptAgent:
    ...
    def set_env_and_task(self, env: TernoShieldEnv, task, llm):
        self.env = env
        self.llm = llm
        self.thoughts = []
        self.responses = []
        ...
        self.system_message = GENRIC_SQL.format(db_type=env.db_type, action_space=action_space, task=self.instruction, max_steps=self.max_steps)
